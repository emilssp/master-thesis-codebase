...
def main():
    ...
    os.makedirs("data/DFP_hx_mult_V30", exist_ok=True)
    np.savez(
        f"data/DFP_hx_mult_V30/temp_{idx:04d}.npz",
        idx=idx,
        temp=temp,
    ...
    if idx == 1:
        ...
        param_file = f"data/DFP_hx_mult_V30/params_{idx:04d}.txt"
