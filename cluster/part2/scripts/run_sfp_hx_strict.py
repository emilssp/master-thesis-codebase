...
def main():
    ...
    bdg_sc(H, atol=1e-6, rtol=1e-3, maxiter=20000, temperature=temp)

    F0 = H.F0
    F, Fuu, Fdd = H.get_correlations()

    os.makedirs("data/SFP_hx_strict", exist_ok=True)
    np.savez(
        f"data/SFP_hx_strict/temp_{idx:04d}.npz",
        idx=idx,
        temp=temp,
    ...
    if idx == 1:
        ...
        param_file = f"data/SFP_hx_strict/params_{idx:04d}.txt"
