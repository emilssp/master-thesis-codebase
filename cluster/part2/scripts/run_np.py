...
def main():
    ...
    fixed_sites = V_prime == 0 and V_prime != 0 
    fixed_syms = ["F0"]
    ...
    os.makedirs("data/NP_part", exist_ok=True)
    np.savez(
        f"data/NP_part/temp_{idx:04d}.npz",
        idx=idx,
        temp=temp,
    ...
    if idx == 1:
        ...
        param_file = f"data/NP_part/params_{idx:04d}.txt"
