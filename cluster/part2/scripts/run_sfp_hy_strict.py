...
def main():
    ...
    bdg_sc(H, atol=1e-8, rtol=1e-4, maxiter=20000, temperature=temp)

    F0 = H.F0
    F, Fuu, Fdd = H.get_correlations()

    os.makedirs("data/SFP_hy_strict", exist_ok=True)
    np.savez(
        f"data/SFP_hy_strict/temp_{idx:04d}.npz",
        idx=idx,
        temp=temp,
    ...
    if idx == 1:
        ...
        param_file = f"data/SFP_hy_strict/params_{idx:04d}.txt"
