...
def main():
    ...
    os.makedirs("data/DFP_hy_partial", exist_ok=True)
    np.savez(
        f"data/DFP_hy_partial/temp_{idx:04d}.npz",
        idx=idx,
        temp=temp,
    ...
    if idx == 1:
        ...
        param_file = f"data/DFP_hy_partial/params_{idx:04d}.txt"
