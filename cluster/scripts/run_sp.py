...
def main():
    ...
    np.savez(
        ...
        idx=idx,
        temp=temp,
        F0=F0[int(widthS+widthP/2)],
        F_swave=F_swave[int(widthS+widthP/2)],
        F_dwave=F_dwave[int(widthS+widthP/2)],
        F_px=F_px[int(widthS+widthP/2)],
        F_py=F_py[int(widthS+widthP/2)],
    )
