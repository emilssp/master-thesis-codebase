...
def bdg_sc(H: Hamiltonian, temperature,  # Hamiltonian
    ...
    for iteration in range(maxiter):
        ...
        # Fuu_xplus = F_xplus_new.copy()
        # Fuu_xmin = F_xmin_new.copy()
        # Fuu_yplus = F_yplus_new.copy()
        # Fuu_ymin = F_ymin_new.copy()

        # Fdd_xplus = F_xplus_new.copy()
        # Fdd_xmin = F_xmin_new.copy()
        # Fdd_yplus = F_yplus_new.copy()
        # Fdd_ymin = F_ymin_new.copy()
