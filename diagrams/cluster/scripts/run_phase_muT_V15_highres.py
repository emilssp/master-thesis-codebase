...
mu_arr = np.linspace(0.01, 4.0, 75)
T_arr_1 = np.linspace(0.001, 0.3, 75)
T_arr_2 = np.linspace(0.001, 0.1, 75)
...
def main():
    ...
    os.makedirs("data/muT_V15_highres", exist_ok=True)
    df_flat.to_json(f"data/muT_V15_highres/results_{idx:04d}.json")
